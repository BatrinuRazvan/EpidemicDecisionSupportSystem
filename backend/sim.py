...
from data_retrieval import store_status_values, del_status_values
...
class People(object):
    ...
    def dailyCounter(self, counter):
        ...
        if (self.env.now % (24) == 0):
            ...
            # Here you would calculate or retrieve your values
            healthy_people = const.nb_of_people - self.nb_dead - self.nb_sick - self.nb_immune
            immune = self.nb_immune
            deaths = self.nb_dead
            sick = self.nb_sick
